...
if (!isset($_SESSION['user']) && empty($_SESSION['user']))
{
    ...
    $_SESSION["previous"]= "https://swe.umbc.edu/~zepp1/is448/project_showcase/Use_Case_3_Computer_Lab.php";
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        if(isset($_POST["statId"]) && !empty($_POST["statId"]) &&
           isset($_POST["statAmount"]) && !empty($_POST["statAmount"])) {
            ...
            header("Location: https://swe.umbc.edu/~zepp1/is448/project_showcase/Use_Case_3_Computer_Lab.php");
...
<div class="header">
    ...
    <div class="fill">
    <h1 class="header1" id="header">Computer Lab</h1><br />
    <p class="r_taskbar">
    <h2>Task</h2><br />
    <ul style="list-style: none;">
    <li>
    <!-- PHP form to activate event-->
    <button id="Intelligence" value="5" name="1" onclick="increment(this.id,'<?php echo $userID?>','notify')"> Work on Group Project</button>
                <span id="notify"></span>
    </li><br />
    <li>
    <!-- PHP form to activate event-->
    <button id="Morale" value="6" name="6" onclick="increment(this.id,'<?php echo $userID?>','notify2')"> Play Computer Games</button>
