...
if (!isset($_SESSION['user']) && empty($_SESSION['user']))
{
	...
	$_SESSION["previous"]= "https://swe.umbc.edu/~zepp1/is448/project_showcase/Use_Case_3_Classroom.php";
	...
	if($_SERVER["REQUEST_METHOD"] == "POST") {
		if(isset($_POST["statId"]) && !empty($_POST["statId"]) &&
		   isset($_POST["statAmount"]) && !empty($_POST["statAmount"])) {
			...
			header("Location: https://swe.umbc.edu/~zepp1/is448/project_showcase/Use_Case_3_Classroom.php");
...
?>
	...
	<div class="fill">
	<h1 class="header1" id="header">Classroom</h1><br />
	<p class="r_taskbar">
	<h2>Task</h2><br />
	<ul style="list-style: none;">
	<li>
	<!-- PHP form to activate event-->
		<button id="Intelligence" value="15" name="1" onclick="increment(this.id,'<?php echo $userID?>','notify')"> Attend Class</button>
				<span id="notify"></span>
		</li><br />
	<li>
	<!-- PHP form to activate event-->
	<button id="Morale" value="10" name="6" onclick="increment(this.id,'<?php echo $userID?>','notify2')"> Attend Study Group</button>
				<span id="notify2"></span>
	</li><br />
	<li>
	<!-- PHP form to activate event-->
	<button id="Charisma" value="15" name="4" onclick="increment(this.id,'<?php echo $userID?>','notify3')"> Attend Seminar</button>
