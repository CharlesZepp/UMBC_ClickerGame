...
if (!isset($_SESSION['user']) && empty($_SESSION['user']))
{
	...
	$_SESSION["previous"]= "https://swe.umbc.edu/~zepp1/is448/project_showcase/Use_Case_3_Parking_Lot.php";
	...
	if($_SERVER["REQUEST_METHOD"] == "POST") {
		if(isset($_POST["statId"]) && !empty($_POST["statId"]) &&
		   isset($_POST["statAmount"]) && !empty($_POST["statAmount"])) {
			...
			header("Location: https://swe.umbc.edu/~zepp1/is448/project_showcase/Use_Case_3_Parking_Lot.php");
...
<div class="fill">
	<h1 class="header1" id="header">Parking Lot</h1><br />
	<p class="r_taskbar">
	<h2>Task</h2><br />
	<ul style="list-style: none;">
	<li>
	<!-- PHP form to activate event-->
	<button id="Luck" value="5" name="2" onclick="increment(this.id,'<?php echo $userID?>','notify')"> Find Parking In Stadium Lot</button>
				<span id="notify"></span>
	</li><br />
	<li>
	<!-- PHP form to activate event-->
	<button id="Morale" value="10" name="6" onclick="increment(this.id,'<?php echo $userID?>','notify2')"> Find Parking Near ITE</button>
				<span id="notify2"></span>
	</li><br />
	<li>
	<!-- PHP form to activate event-->
	<button id="Strength" value="50" name="3" onclick="increment(this.id,'<?php echo $userID?>','notify3')"> Sleep In Car</button>
	...
	<img class="r_playericon" src="image/mrClick.png" alt="Mr. Click"/>
	</p>
	<!--
	<form class="bottomRight" action="https://swe.umbc.edu/~ryans5/is448/group_project/Use_Case_3_World_Map.php" method="post">
