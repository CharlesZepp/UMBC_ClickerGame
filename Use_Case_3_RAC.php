...
if (!isset($_SESSION['user']) && empty($_SESSION['user']))
{
	...
	$_SESSION["previous"]= "https://swe.umbc.edu/~zepp1/is448/project_showcase/Use_Case_3_RAC.php";
	...
	if($_SERVER["REQUEST_METHOD"] == "POST") {
		if(isset($_POST["statId"]) && !empty($_POST["statId"]) &&
		   isset($_POST["statAmount"]) && !empty($_POST["statAmount"])) {
			...
			header("Location: https://swe.umbc.edu/~zepp1/is448/project_showcase/Use_Case_3_RAC.php");
...
<div class="header">
	...
	<div class="fill">
	<h1 class="header1" id="header">RAC</h1><br />
	<p class="r_taskbar">
	<h2>Task</h2><br />
	<ul style="list-style: none;">
	<li>
	<!-- PHP form to activate event-->
	<button id="Strength" value="5" name="3" onclick="increment(this.id,'<?php echo $userID?>','notify')"> Workout</button>
				<span id="notify"></span>
	</li><br />
	<li>
	<!-- PHP form to activate event-->
	<button id="Luck" value="6" name="2" onclick="increment(this.id,'<?php echo $userID?>','notify2')"> Swim</button>
