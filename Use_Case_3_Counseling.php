...
if (!isset($_SESSION['user']) && empty($_SESSION['user']))
{
	...
	$_SESSION["previous"]= "https://swe.umbc.edu/~zepp1/is448/project_showcase/Use_Case_3_Counseling.php";
	...
	if($_SERVER["REQUEST_METHOD"] == "POST") {
		if(isset($_POST["statId"]) && !empty($_POST["statId"]) &&
		   isset($_POST["statAmount"]) && !empty($_POST["statAmount"])) {
			...
			header("Location: https://swe.umbc.edu/~zepp1/is448/project_showcase/Use_Case_3_Counseling.php");
...
<div class="header">
	...
	<div class="fill">
	<h1 class="header1" id="header">Counseling</h1><br />
	<p class="r_taskbar">
	<h2>Task</h2><br />
	<ul style="list-style: none;">
	<li>
	<!-- PHP form to activate event-->
	<button id="Intelligence" value="5" name="1" onclick="increment(this.id,'<?php echo $userID?>','notify')"> Schedule Future Classes</button>
				<span id="notify"></span>
	</li><br />
	<li>
	<!-- PHP form to activate event-->
	<button id="Job Outlook" value="6" name="5" onclick="increment(this.id,'<?php echo $userID?>','notify2')"> Meet With Advisor</button>
				<span id="notify2"></span>
	</li><br />
	<li>
	<!-- PHP form to activate event-->
	<button id="Luck" value="1" name="2" onclick="increment(this.id,'<?php echo $userID?>','notify3')"> Change Major</button>
